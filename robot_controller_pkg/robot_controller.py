...
class Controller(Node):
  ...
  def __init__(self):
    ...
    self.turning_speed_wf_fast = 1.82  # Fast turn
    self.turning_speed_wf_slow = 1.0 # Slow turn
    ...
    self.dist_too_close_to_wall = 0.30 # in meters
  ...
  def follow_wall(self):
    ...
    if self.leftfront_dist > d and self.front_dist > d and self.rightfront_dist > d:
      ...
      pass    # Send velocity command to the robot
